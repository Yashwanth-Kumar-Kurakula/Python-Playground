...
FLY_FROM = "HYD"  # Change this field to IATA code of the place you want to fly from
FLY_TO = "MEL"    # Change this field to IATA code of the place you want to fly
...
def dt_formatter(dt):
    ...
    Args:
        dt (str): Input date and time string.
...
class FlightSearch:
    ...
    def get_price(self):
        """
        Fetches flight prices using the Tequila API.
...
# Instantiate FlightSearch class
fs = FlightSearch()
data = fs.get_price()
...
# Load airline codes from a file
